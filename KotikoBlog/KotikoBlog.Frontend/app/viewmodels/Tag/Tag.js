...
define(
    ...
    function TagPaginatedViewModel($, config, i18n, stringUtils,
                        findRequestImpl, pageImpl, pagerImpl, pageRequestImpl, validationUtils,
                        app, alerts, shell, BlogPostBroker, BlogPostFilterImpl, BlogPostSortImpl, BlogPostImpl, securityContext,BlogCategoryBroker, BlogTagBroker) {
        var viewModel = {},
        ...
        function loadPageByIndex(index, totalElements) {
            if (index === 0 || index > 0 && index < currentPage().totalPages) {
                ...
                return BlogPostBroker.getAllPaginatedByTag(
